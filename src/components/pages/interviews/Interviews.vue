...
<template>
  ...
  >
    <PageHeader
      hint-text="Календарь слотов собеседований. Цветом показано, сколько экспертов доступно в каждые 30 минут. Нажмите на слот, чтобы посмотреть состав экспертов и детали"
